...
function empregos(opcoes) {
  ...
  if (opcoes[escolha] == "[0] Trabalhar empenhado") {
    ...
    //a variavel jeff.zerouVida deve ser alterada somente se essa opção for selecionada
    ...
    if (sorte == 5) {
      ...
      console.clear();
      console.log("Jeff jeff.zerouVida!!!");
      console.log();
      console.log("FIM DE JOGO");

      jeff.zerouVida = true;
      console.log(jeff.zerouVida);
      //mude jeff.zerouVida para
      return;
    } else {
